...
// import App from "./BakedShadow.tsx";
import App from "./SimpleShadow.tsx";
import "./style.css";
...
window.addEventListener("resize", () => {
	root.configure({
		...
		gl: {
			...
			//? Make the colors same as vanilla example:
			//? https://stackoverflow.com/a/71802525
